...
#import "NSArray+JoySafe.h"
#import "NSObject+JoyCategory.h"
#import <objc/runtime.h>

@implementation NSArray (JoySafe)
#ifdef RELEASE
+(void)load{
    [super load];
...
@implementation NSMutableArray (JoySafe)
#ifdef RELEASE
+(void)load{
    [super load];
    [objc_getClass("__NSArrayM") swizzleMethod:@selector(objectAtIndex:) swizzledSelector:@selector(joyObjectAtIndex:)];
