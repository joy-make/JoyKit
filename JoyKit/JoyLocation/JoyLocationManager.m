...
#pragma mark 开始定位
-(JoyLocationManager *(^)(void))startLocation{
    __weak __typeof(&*self)weakSelf = self;
    return ^(){
...
#pragma mark 结束定位
-(JoyLocationManager *(^)(void))stopLocation{
    __weak __typeof(&*self)weakSelf = self;
    return ^(){
...
#pragma mark 更新角度
-(JoyLocationManager *(^)(void))startUpdateHeading{
    __weak __typeof(&*self)weakSelf = self;
    return ^(){
...
#pragma mark 停止更新角度
-(JoyLocationManager *(^)(void))stopUpdateHeading{
    __weak __typeof(&*self)weakSelf = self;
    return ^(){
