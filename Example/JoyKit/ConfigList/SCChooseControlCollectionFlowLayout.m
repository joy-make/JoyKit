//
//  SCChooseControlCollectionFlowLayout.m
//  Property_pro
//
...
#import "SCChooseControlCollectionFlowLayout.h"
@interface SCChooseControlCollectionFlowLayout(){
    //在居中对齐的时候需要知道这行所有cell的宽度总和
    CGFloat _sumCellWidth ;
}
@end
@implementation SCChooseControlCollectionFlowLayout
-(instancetype)init{
